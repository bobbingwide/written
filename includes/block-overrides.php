 ...
 */
add_filter( 'register_block_type_args', 'written_register_block_type_args', 9 );
 ...
 * @return array
 */
function written_register_block_type_args( $args ) {
    //$args = written_maybe_override_block(  $args,'core/query-pagination', 'render_block_core_query_pagination');
	//$args = written_maybe_override_block(  $args,'core/query-pagination-numbers', 'render_block_core_query_pagination_numbers');

	//$args = written_maybe_override_block(  $args,'core/query-loop', 'render_block_core_query_loop' );
    //$args = written_maybe_override_block(  $args,'core/post-excerpt', 'render_block_core_post_excerpt' );
    //$args = written_maybe_override_block(  $args,'core/post-content', 'render_block_core_post_content' );
